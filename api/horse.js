// api/horse.js — fetch-only, streams image/* bytes
...
const QUERIES = [
  "horse",
  "horse running in field photo",
  "wild horse close up photo",
  "horse portrait photography",
  "stallion in nature photo",
  "mare grazing in meadow photo",
  "horse head close up portrait",
  "foal with mare wildlife photo",
  "horse photography outdoors"
];

const FALLBACKS = [
  "https://upload.wikimedia.org/wikipedia/commons/1/1a/Horse_in_field.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/f/f9/Horse_portrait.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/d/de/Wild_Horse_in_the_field.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/3/3f/Horse_and_foal_in_meadow.jpg"
];
...
export default async function handler(req,res){
  ...
  if(!serpKey){
    ...
    res.setHeader("Content-Disposition", `inline; filename="horse.${data.ext}"`);
  ...
  try{
    ...
    return res.status(404).json({ ok:false, error:"no_usable_horse_found" });
  }
}
